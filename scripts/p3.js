...
const privateKey =
  "ef271ad31a87f154cd7b1fb91dd7ae0bc79dcb7dc744b23d2cf49fe507cdc2eb";
...
async function main() {
  ...
  async function dealCards() {
    ...
    if (gameStarted && !cardsDealt) {
      ...
      /*
    const randomNumberQuestionsProvider =
      receipt2.events.FlipResultQuestions.returnValues.randomNumber;
    console.log(`Questions Num: ${randomNumberQuestionsProvider}`);
    */
